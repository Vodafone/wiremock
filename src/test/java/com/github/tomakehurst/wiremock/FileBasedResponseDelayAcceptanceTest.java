...
public class FileBasedResponseDelayAcceptanceTest extends AcceptanceTestBase {
  ...
  @Test
  public void responseWithFileBasedCappedLogNormalDelay() {
    testFileBasedDistribution("/file_based_distribution/capped_log_normal", 60);
  }

  @Test
  public void fileBasedDistributionExistanceCheck() {
    setupStub("/file_based_distribution/capped_log_normal");
